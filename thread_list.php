...
<body>
    ...
    if ($method == 'POST') {
        ...
        if ($showalert) {
            ...
            <strong>Success! </strong> youe thread has submitted please wait for community to respond
    ...
    <div class="container my-4" id="ques">
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <p>this is a perr to perr forum for sharing knowledge with each other Participate in online forums as you
                would in constructive, face-to-face discussions. Do not post “I agree,” or similar, statements. ... Stay
                on the topic of the thread.</p>
    ...
    <div class="continer">
        ...
        echo '
         <div class="continer">
         <h1 class="py-2">Start a Discussion</h1>
            <h5 class="py-2">You are not logged in! PLEASE login to be able to start a Discussion</h5>
        </div>';
    }
    ?>
